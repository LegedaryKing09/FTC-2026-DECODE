...
@Config
@Autonomous(name = "New Pathing for FB", group = "Test")
public class NewPathingForFB extends LinearOpMode {
    ...
    public static double THIRD_SPLINE_X = 20.0;
    public static double THIRD_SPLINE_Y = -78.0;
    public static double FIRST_COMEBACK_X = 0.0;
    public static double FIRST_COMEBACK_Y = 0.0;
    public static double SECOND_COMEBACK_X = 20.0;
    public static double SECOND_COMEBACK_Y = -54.0;
    ...
    public static double FIRST_COMEBACK_ANGLE = 10.0;
    public static double SECOND_COMEBACK_ANGLE = -90.0;
    public static double THIRD_COMEBACK_ANGLE = -90.0;
    ...
    private void executeAutonomousSequence() {
        ...
        Action splineBackward = tankDrive.actionBuilder(currentPose)
                .setReversed(true)
                .splineTo(new Vector2d(FIRST_COMEBACK_X, FIRST_COMEBACK_Y), Math.toRadians(FIRST_COMEBACK_ANGLE))
                .build();
        ...
        Action splineBackward2 = tankDrive.actionBuilder(currentPose)
                .setReversed(true)
                .splineTo(new Vector2d(SECOND_COMEBACK_X, SECOND_COMEBACK_Y), Math.toRadians(SECOND_COMEBACK_ANGLE))
                .build();
        ...
        Action splineBackward3 = tankDrive.actionBuilder(currentPose)
                .setReversed(true)
                .splineTo(new Vector2d(THIRD_COMEBACK_X, THIRD_COMEBACK_Y), Math.toRadians(THIRD_COMEBACK_ANGLE))
                .build();
